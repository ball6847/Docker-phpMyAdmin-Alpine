...
# now make config.inc.php writable ny setup script, just go to /setup/index.php
ln -s /www/phpmyadmin/config.inc.php /www/phpmyadmin/config/config.inc.php
